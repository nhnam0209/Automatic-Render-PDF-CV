...
def fill(data, media_path=None):
    ...
    #     contact += "\\\\\n"
    if contact != "":
        contact = "\\begin{flushleft}\\section{PERSONAL INFO}\n\n\\vspace{6pt}\n\\begin{itemize}\n" + contact + "\n\\end{itemize}\\end{flushleft}"
